...
class TransactionBaseImpl : public Transaction {
 public:
  ...
  Status GetForUpdate(const ReadOptions& options,
                      ...
                      std::string* value, bool exclusive, std::atomic<bool>* callback) override;

  Status GetForUpdate(const ReadOptions& options,
                      ColumnFamilyHandle* column_family, const Slice& key,
                      PinnableSlice* pinnable_val, bool exclusive, std::atomic<bool>* callback) override;
  ...
  virtual Status DoPut(ColumnFamilyHandle* column_family, const Slice& key,
               const Slice& value, bool optimistic = false, std::atomic<bool>* callback = nullptr) override;

  virtual Status DoDelete(ColumnFamilyHandle* column_family, const Slice& key, bool optimistic = false,
      std::atomic<bool>* callback = nullptr) override;

  virtual Status DoGet(const ReadOptions& options, ColumnFamilyHandle* column_family, const Slice& key, std::string* value, bool optimistic = false, std::atomic<bool>* = nullptr) override;
  ...
  Status DoPessimisticLock(ColumnFamilyHandle* column_family, const Slice& key, bool read_only, bool exclusive, bool fail_fast, bool untracked = false, std::atomic<bool>* callback = nullptr) {
  return DoPessimisticLock(GetColumnFamilyID(column_family), key, read_only, exclusive, fail_fast, untracked, callback); 
}

  virtual Status DoPessimisticLock(uint32_t cf_id, const Slice& key, bool read_only, bool exclusive, bool fail_fast, bool untracked = false, std::atomic<bool>* callback = nullptr) = 0;
